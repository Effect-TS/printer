/**
 * @tsplus static effect/printer/Doc.Ops getAssociative
 */
...
/**
 * @tsplus static effect/printer/Doc.Ops getAssociativeIdentity
 */
...
/**
 * @tsplus static effect/printer/Doc.Ops Covariant
 */
